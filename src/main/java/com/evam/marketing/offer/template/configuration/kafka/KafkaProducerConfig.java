package com.evam.marketing.offer.template.configuration.kafka;
...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, CustomOfferResponseEvent> kafkaTemplate() {
        return new KafkaTemplate<>(producerFactory());
    }

    private ProducerFactory<String, CustomOfferResponseEvent> producerFactory() {
